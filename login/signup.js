  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginBottom: 30 }}>
        ...
        >
          <Feather name="user" size={20} color="purple" style={styles.icon1} />
          <TextInput
            placeholder="Name"
        ...
        >
          <Feather name="mail" size={20} color="purple" style={styles.icon1} />
          <TextInput
            placeholder="Email"
      ...
      {!keyboardOpen && (
        <View style={[styles.bottom, { bottom: 100 }]}>
          ...
          >
            <Text style={[styles.text, { fontSize: 14,color:"pink" }]}>Login</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
